    ...
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-x-8 lg:px-8 lg:py-32">
        <div class="lg:col-span-4">
            ...
            <div class="mt-3 flex items-center">
                ...
                <p class="ml-2 text-sm text-gray-900">Based on {{ $countReviewsForProduct ?? '0' }} reviews</p>
            </div>
                        ...
                        <dt class="flex flex-1 items-center">
                            ...
                            <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                                ...
                                <div class="relative ml-3 flex-1">
                                    ...
                                    <div style="width: {{ $ratingPercentage[5] ?? '0'}}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                                </div>
                            </div>
                        </dt>
                        <dd class="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">{{ $ratingPercentage[5] ?? '0'}}%</dd>
                    </div>
                    <div class="flex items-center text-sm">
                        <dt class="flex flex-1 items-center">
                            ...
                            <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                                ...
                                <div class="relative ml-3 flex-1">
                                    <div class="h-3 rounded-full border border-gray-200 bg-gray-100"></div>
                                    <div style="width: {{ $ratingPercentage[4] ?? '0' }}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                                </div>
                            </div>
                        </dt>
                        <dd class="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">{{ $ratingPercentage[4] ?? '0' }}%</dd>
                    </div>
                    <div class="flex items-center text-sm">
                        <dt class="flex flex-1 items-center">
                            ...
                            <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                                ...
                                <div class="relative ml-3 flex-1">
                                    <div class="h-3 rounded-full border border-gray-200 bg-gray-100"></div>
                                    <div style="width: {{ $ratingPercentage[3] ?? '0' }}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                                </div>
                            </div>
                        </dt>
                        <dd class="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">{{ $ratingPercentage[3] ?? '0' }}%</dd>
                    </div>
                    <div class="flex items-center text-sm">
                        <dt class="flex flex-1 items-center">
                            ...
                            <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                                ...
                                <div class="relative ml-3 flex-1">
                                    <div class="h-3 rounded-full border border-gray-200 bg-gray-100"></div>
                                    <div style="width: {{ $ratingPercentage[2] ?? '0' }}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                                </div>
                            </div>
                        </dt>
                        <dd class="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">{{ $ratingPercentage[2] ?? '0' }}%</dd>
                    </div>
                    <div class="flex items-center text-sm">
                        <dt class="flex flex-1 items-center">
                            ...
                            <div aria-hidden="true" class="ml-1 flex flex-1 items-center">
                                ...
                                <div class="relative ml-3 flex-1">
                                    <div class="h-3 rounded-full border border-gray-200 bg-gray-100"></div>
                                    <div style="width: {{ $ratingPercentage[1] ?? '0' }}%" class="absolute inset-y-0 rounded-full border border-yellow-400 bg-yellow-400"></div>
                                </div>
                            </div>
                        </dt>
                        <dd class="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">{{ $ratingPercentage[1] ?? '0' }}%</dd>
                    </div>
                </dl>
            </div>
        ...
        <div class="mt-16 lg:col-span-7 lg:col-start-6 lg:mt-0">
            ...
            <div class="flow-root">
                <div class="-my-12 divide-y divide-gray-200">
                    @foreach($reviewsForProduct as $reviewView)
                    <div class="py-12">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="mt-1 flex items-center">
                                    @for($i = 0; $i < $reviewView->rating; $i++)
                                        <svg class="text-yellow-400 h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z" clip-rule="evenodd" />
                                        </svg>
                                    @endfor
                                    @for($i = $reviewView->rating; $i < 5; $i++)
                                        <svg class="text-gray-300 h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z" clip-rule="evenodd" />
                                        </svg>
                                    @endfor
